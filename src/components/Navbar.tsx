...
import "../app/stylying/navbar.css"
    ...
    <>
      <header>
        <nav className="navbar">
          <h1 className="logo" onClick={toggleMenu}>Alishba</h1>
          <button onClick={toggleMenu} className="menu-button" type="button" title="Toggle Menu">
            <FontAwesomeIcon icon={isOpen ? faTimes : faBars} color="#fff" />
          </button>
          <ul className={`menu ${isOpen ? 'show' : ''}`}>
            ...
            <li>
              <Link href="#skills" onClick={handleSmoothScroll}>Skill</Link>
            </li>
